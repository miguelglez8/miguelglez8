...
<#if (getterUtil.getString(theme_settings['pages-icon']!"", "") =="Default")>
	<script type="text/javascript">		
		$( document ).ready(function() {
			...
			$('.icon-item2').addClass('fa fa-clock-o');
			$('.icon-item3').addClass('fa fa-history');
			$('.icon-item4').addClass('fa fa-user');
			$('.icon-item5').addClass('fa fa-info-circle');
			$('.icon-item6').addClass('fa fa-question-circle');
			$('.item6').addClass('layout-support');
			$('.icon-item7').addClass('fa fa-users');
			$('.icon-item8').addClass('fa fa-calendar');
			$('.icon-item9').addClass('fa fa-wrench');
			$('.icon-item10').addClass('fa fa-cog');
			$('.icon-item11').addClass('fa fa-file');
			$('.icon-item12').addClass('fa fa-play-circle');
			$('.icon-item13').addClass('fa fa-info-circle');
			$('.icon-item14').addClass('fa fa-paper-plane');
			$('.icon-item15').addClass('fa fa-laptop');
			$('.icon-item16').addClass('fa fa-table');
			$('.icon-item17').addClass('fa fa-shopping-cart');
			$('.icon-item18').addClass('fa fa-picture-o');
			$('.icon-item19').addClass('fa fa-sitemap');
			$('.icon-item20').addClass('fa fa-magic');
			$('.icon-item21').addClass('fa fa-database');
		...
		$("#side-menu .item6").insertAfter($("#side-menu li:last"));
	</script>	
</#if>
