...
public class PrevingMailUtil {
    ...
    public static void sendMail(long userId, String subject, String message){
        ...
        String adminEmailAddressProps = PrefsPropsUtil.getString(CompanyConfigurationPortletKeys.CONFIGURATION_COMPANY_CONF_USER_EMAIL);
        if(!Validator.isBlank(adminEmailAddressProps)){
            adminEmailAddress = adminEmailAddressProps;
        }

        String adminEmailName = "Test";
        String adminEmailNameProps = PrefsPropsUtil.getString(CompanyConfigurationPortletKeys.CONFIGURATION_COMPANY_CONF_USER_NAME);
        if(!Validator.isBlank(adminEmailAddressProps)){
