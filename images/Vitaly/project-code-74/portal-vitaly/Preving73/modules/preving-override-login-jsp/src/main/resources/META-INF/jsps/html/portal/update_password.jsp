...
String texto = "La contrase&ntilde;a debe tener al menos 8 caracteres con may&#250;sculas, min&#250;sculas y n&#250;meros.";
String texto_ca_ES = "La contrasenya ha de tenir com a m&#237;nim 8 car&#224;cters amb maj&#250;scules, min&#250;scules i nombres.";

System.out.println(" 1: "+themeDisplay.getLocale());
System.out.println(" 2: "+themeDisplay.getUser().getLocale());
System.out.println(" 3: "+themeDisplay.getUser().getLocale().toString());

if(themeDisplay.getUser().getLocale().toString().equals("ca_ES")){
	texto = texto_ca_ES;
}else if(themeDisplay.getLocale().toString()=="eu_ES"){
	texto="Pasahitzak ... izan behar du";
}
