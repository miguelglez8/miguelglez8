...
@Component(
        immediate = true,
        service = PrevingMessagingConfigurator.class
)
public class PrevingMessagingConfigurator {

    private static Log _log = LogFactoryUtil.getLog(PrevingMessagingConfigurator.class);
    ...
    protected void activate(BundleContext bundleContext) {
        ...
        if(_log.isDebugEnabled()){
            _log.debug("activate MessagingConfigurator");
        }
        ...
        DestinationConfiguration destinationConfiguration =
                new DestinationConfiguration(DestinationConfiguration.DESTINATION_TYPE_PARALLEL, CreateCompanyPortletKeys.MESSAGE_BUS_DESTINATION_NAME_SITE_TEMPLATE);

        // Set the DestinationConfiguration's max queue size and rejected execution handler.
        ...
        ServiceRegistration<Destination> serviceRegistration =
                _bundleContext.registerService(Destination.class, destination, properties);
        ...
        if(_log.isDebugEnabled()){
            _log.debug("destination.name: " + destination.getName());
            _log.debug("destinationConfiguration: " + destinationConfiguration);
        }
    }
