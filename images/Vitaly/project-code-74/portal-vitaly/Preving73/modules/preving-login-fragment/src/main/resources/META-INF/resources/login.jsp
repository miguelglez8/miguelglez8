            ...
            <div>
                <ul class="list-unstyled taglib-icon-list">
                    <li class="" role="presentation">
                        <a href="/web/guest/home/-/login/openid_connect_request?_com_liferay_login_web_portlet_LoginPortlet_redirect=/&amp;_com_liferay_login_web_portlet_LoginPortlet_OPEN_ID_CONNECT_PROVIDER_NAME=RegistroHorario_web" target="_self" class=" lfr-icon-item taglib-icon" id="_com_liferay_login_web_portlet_LoginPortlet_suxb__column2__0" role="menuitem" >
                            <span class="taglib-text ">Acceder a través de la Suite Adeplus</span>
                        </a>
                    </li>

                    <li class="" role="presentation">
                        <a href="/web/guest?p_p_id=com_liferay_login_web_portlet_LoginPortlet&amp;p_p_lifecycle=0&amp;p_p_state=maximized&amp;p_p_mode=view&amp;_com_liferay_login_web_portlet_LoginPortlet_mvcRenderCommandName=%2Flogin%2Fforgot_password&amp;saveLastPath=false" target="_self" class=" lfr-icon-item taglib-icon" id="_com_liferay_login_web_portlet_LoginPortlet_gezi__column2__0" role="menuitem" >
