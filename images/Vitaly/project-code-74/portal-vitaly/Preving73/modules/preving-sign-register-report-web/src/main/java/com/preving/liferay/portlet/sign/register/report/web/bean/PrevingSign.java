package com.preving.liferay.portlet.sign.register.report.web.bean;
...
public class PrevingSign {
    ...
    public String getUserName() {
        ...
        try {
            ...
            return Validator.isNotNull(userData)?userData.getName() + " " + userData.getLastName():user.getFullName();
    ...
    public String getJobTitle(){
        try {
            ...
            return Validator.isNotNull(userData)?userData.getJobTitle():user.getJobTitle();
