package com.canal.etico.liferay.portlet.accion.web.portlet;
...
@Component(
	...
	property = {
		...
		"javax.portlet.display-name=Accion",
...
public class AccionPortlet extends MVCPortlet {
	...
	public void doView(RenderRequest renderRequest, RenderResponse renderResponse) throws IOException, PortletException {
		...
		List<Accion> list = AccionLocalServiceUtil.getAllAccionesFromCompany(companyIdFromUser);

		renderRequest.setAttribute(AccionPortletKeys.ACCIONES_LIST, list);
		renderRequest.setAttribute(AccionPortletKeys.COMPANY_ID, companyIdFromUser);
