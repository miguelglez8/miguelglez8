...
public interface UserRoleLocalService
	...
	public UserRole createUserRole(UserRolePK userRolePK);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public UserRole deleteUserRole(UserRolePK userRolePK)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public UserRole fetchUserRole(UserRolePK userRolePK);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public UserRole getUserRole(long userId, long compId, long roleId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public UserRole getUserRole(UserRolePK userRolePK) throws PortalException;
