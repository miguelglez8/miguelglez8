...
public interface RoleLocalService
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Role> getRoleByApplicationId(long applicationId);
