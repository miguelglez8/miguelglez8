...
/**
 * Provides the local service interface for UserCompanyClient. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see UserCompanyClientLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface UserCompanyClientLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.adeplus.liferay.portlet.suite.manager.service.impl.UserCompanyClientLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the user company client local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link UserCompanyClientLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public UserCompanyClient addUserCompanyClient(
	...
	public UserCompanyClient createUserCompanyClient(
	...
	public UserCompanyClient deleteUserCompanyClient(
		UserCompanyClient userCompanyClient);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public UserCompanyClient fetchUserCompanyClient(
		UserCompanyClientPK userCompanyClientPK);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public UserCompanyClient getUserCompanyClient(
			UserCompanyClientPK userCompanyClientPK)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<UserCompanyClient> getUserCompanyClients(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public UserCompanyClient updateUserCompanyClient(
		UserCompanyClient userCompanyClient);
