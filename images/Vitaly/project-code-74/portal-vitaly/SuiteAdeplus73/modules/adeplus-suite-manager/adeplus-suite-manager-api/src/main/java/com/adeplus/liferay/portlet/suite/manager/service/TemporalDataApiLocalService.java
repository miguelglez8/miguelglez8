...
/**
 * Provides the local service interface for TemporalDataApi. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see TemporalDataApiLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface TemporalDataApiLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.adeplus.liferay.portlet.suite.manager.service.impl.TemporalDataApiLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the temporal data api local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link TemporalDataApiLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public TemporalDataApi addTemporalDataApi(TemporalDataApi temporalDataApi);
	...
	public TemporalDataApi createTemporalDataApi(long idDataTemporal);
	...
	public TemporalDataApi deleteTemporalDataApi(long idDataTemporal)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public TemporalDataApi deleteTemporalDataApi(
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TemporalDataApi fetchTemporalDataApi(long idDataTemporal);

	public List<TemporalDataApi> findProcesado(int procesado);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TemporalDataApi getTemporalDataApi(long idDataTemporal)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<TemporalDataApi> getTemporalDataApis(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public TemporalDataApi updateTemporalDataApi(
		TemporalDataApi temporalDataApi);
