...
public interface ApplicationLocalService
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Application getApplicationByAlias(String alias);
