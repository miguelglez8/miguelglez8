...
public interface CompLocalService
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Comp getCompByCif(String cif);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Comp getCompsByNameAndCif(String name, String cif);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Comp> getCompsToInactive(Date endDate);
