...
/**
 * Provides the local service interface for ApplicationLicense. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ApplicationLicenseLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ApplicationLicenseLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.adeplus.liferay.portlet.suite.manager.service.impl.ApplicationLicenseLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the application license local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ApplicationLicenseLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public ApplicationLicense addApplicationLicense(
	...
	public ApplicationLicense createApplicationLicense(long licenseId);
	...
	public ApplicationLicense deleteApplicationLicense(
		ApplicationLicense applicationLicense);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public ApplicationLicense deleteApplicationLicense(long licenseId)
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ApplicationLicense fetchApplicationLicense(long licenseId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ApplicationLicense fetchByAppLicense(
		long applicationId, long licenseId);

	public List<ApplicationLicense> findByApplicationId(long applicationId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ApplicationLicense getApplicationLicense(long licenseId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ApplicationLicense> getApplicationLicenses(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public ApplicationLicense updateApplicationLicense(
		ApplicationLicense applicationLicense);
