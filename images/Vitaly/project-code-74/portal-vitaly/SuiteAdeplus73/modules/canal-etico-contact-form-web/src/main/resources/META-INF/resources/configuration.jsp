<%@ page import="com.canal.etico.liferay.portlet.contact.form.web.constants.ContactPortletKeys" %>
...
<%@ page import="com.canal.etico.liferay.portlet.contact.form.web.util.AdeplusCategoryUtil" %>
...
<%
    ...
    Map<Locale, String> categoriesLocalized = LocalizationUtil.getLocalizationMap(preferences, ContactPortletKeys.CATEGORIES_CONFIGURATION);
