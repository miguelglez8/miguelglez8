...
<%
	...
	boolean adminRole = PlanIgualdadRoleUtil.isAdministradorRole(themeDisplay.getCompanyId(), themeDisplay.getUser());
%>
    ...
    <div class="formulario">
		...
		<div class="form-content prv-form">
			...
			<div class="row align-items-start mb-4">
                ...
                <div class="col-lg-6 col-md-3 col-12 d-flex">
                    ...
                    <fieldset class="d-flex">
                     ...
                     <div class="checksBorder">
                         <div class="custom-control custom-radio mr-4">
                             <input class="form-check-input filter-item" name="estado" id="inpSearchState1" value="asignadas" type="radio" />
					<label class="form-check-label" for="inpSearchState1">
						<liferay-ui:message key="company.view.estado.asignadas"/>
					</label>
                         </div>
                         <div class="custom-control custom-radio mr-4">
                            <input class="form-check-input filter-item" name="estado" id="inpSearchState2" value="no-asignadas" type="radio"/>
					<label class="form-check-label" for="inpSearchState2">
						<liferay-ui:message key="company.view.estado.noAsignadas"/>
					</label>
				</div>
                         <div class="custom-control custom-radio mr-4">
                             <input class="form-check-input filter-item" name="estado" id="inpSearchState3" value="todos" type="radio" checked="v"/>
					<label class="form-check-label" for="inpSearchState3">
						<liferay-ui:message key="company.view.estado.todos"/>
					</label>
				</div>
                     </div>
                 </fieldset>
