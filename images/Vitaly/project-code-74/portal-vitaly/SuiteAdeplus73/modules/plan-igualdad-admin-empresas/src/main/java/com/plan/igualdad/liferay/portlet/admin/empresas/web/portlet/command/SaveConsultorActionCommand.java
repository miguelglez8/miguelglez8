...
public class SaveConsultorActionCommand implements MVCActionCommand {
    ...
    public boolean processAction(ActionRequest actionRequest, ActionResponse actionResponse) throws PortletException {
        ...
        String appAlias = actionRequest.getPreferences().getValue(AdminEmpresasPortletKeys.APP_ALIAS, StringPool.BLANK);
        Application application = ApplicationLocalServiceUtil.getApplicationByAlias(appAlias);
