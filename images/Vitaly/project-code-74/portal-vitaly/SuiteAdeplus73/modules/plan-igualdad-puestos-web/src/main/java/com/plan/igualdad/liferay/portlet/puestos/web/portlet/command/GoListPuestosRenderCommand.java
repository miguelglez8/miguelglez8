...
public class GoListPuestosRenderCommand implements MVCRenderCommand {
    ...
    public String render(RenderRequest renderRequest, RenderResponse renderResponse) throws PortletException {
        ...
        if (PlanIgualdadRoleUtil.isAdministradorRole(themeDisplay.getCompanyId(), themeDisplay.getUser())
            ...
            compId = request.getParameter(PlanIgualdadPuestosWebPortletKeys.QUERY_PARAM);

            if (Validator.isNull(compId)) compId = ParamUtil.getString(renderRequest, PlanIgualdadPuestosWebPortletKeys.COMPID_PARAM);
        ...
        renderRequest.setAttribute(PlanIgualdadPuestosWebPortletKeys.VERSIONID_PARAM, version.getVersionId());
