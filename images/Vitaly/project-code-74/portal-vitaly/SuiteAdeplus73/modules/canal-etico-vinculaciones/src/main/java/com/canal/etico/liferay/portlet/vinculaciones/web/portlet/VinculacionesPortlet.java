package com.canal.etico.liferay.portlet.vinculaciones.web.portlet;
...
@Component(
	...
	property = {
		...
		"javax.portlet.display-name=Vinculaciones",
...
public class VinculacionesPortlet extends MVCPortlet {
	...
	public void doView(RenderRequest renderRequest, RenderResponse renderResponse) throws IOException, PortletException {
		...
		List<Vinculacion> list = VinculacionLocalServiceUtil.getAllVinculacionesFromCompany(companyIdFromUser);

		renderRequest.setAttribute(VinculacionesPortletKeys.VINCULACIONES_LIST, list);
		renderRequest.setAttribute(VinculacionesPortletKeys.COMPANY_ID, companyIdFromUser);
