 ...
 * <code>com.canal.etico.liferay.portlet.canal.manager.service.impl.CompLocalServiceImpl</code> and
...
public class CompLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.canal.etico.liferay.portlet.canal.manager.service.impl.CompLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static com.canal.etico.liferay.portlet.canal.manager.model.Comp
		addComp(com.canal.etico.liferay.portlet.canal.manager.model.Comp comp) {
	...
	public static java.util.List
		...
		return getService().getCompaniesByCIF(cif);
	}

	public static com.canal.etico.liferay.portlet.canal.manager.model.Comp
		getCompanyByCIF(String cif) {

		return getService().getCompanyByCIF(cif);
	}

	public static com.canal.etico.liferay.portlet.canal.manager.model.Comp
		getCompanyByFriendlyURL(String friendlyURL) {

		return getService().getCompanyByFriendlyURL(friendlyURL);
	}

	public static com.canal.etico.liferay.portlet.canal.manager.model.Comp
		getCompanyBySuiteCompId(long suiteCompId) {

		return getService().getCompanyBySuiteCompId(suiteCompId);
	}
	...
	private static ServiceTracker<CompLocalService, CompLocalService>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(CompLocalService.class);

		ServiceTracker<CompLocalService, CompLocalService> serviceTracker =
			new ServiceTracker<CompLocalService, CompLocalService>(
				bundle.getBundleContext(), CompLocalService.class, null);
