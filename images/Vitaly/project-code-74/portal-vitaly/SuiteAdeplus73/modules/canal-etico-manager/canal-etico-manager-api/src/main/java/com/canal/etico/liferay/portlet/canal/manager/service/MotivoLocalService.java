...
/**
 * Provides the local service interface for Motivo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see MotivoLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface MotivoLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.canal.etico.liferay.portlet.canal.manager.service.impl.MotivoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the motivo local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link MotivoLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Motivo createMotivo(long motivoId);
	...
	public Motivo deleteMotivo(long motivoId) throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Motivo deleteMotivo(Motivo motivo);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Motivo fetchMotivo(long motivoId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ActionableDynamicQuery getActionableDynamicQuery();

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Motivo> getAllMotivosActiveFromCompany(long compId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Motivo> getAllMotivosFromCompany(long compId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Motivo getMotivo(long motivoId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Motivo> getMotivos(int start, int end);
