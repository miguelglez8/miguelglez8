...
public class CompWrapper
	...
	public Map<String, Object> getModelAttributes() {
		...
		attributes.put("suiteCompId", getSuiteCompId());
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		...
		Long suiteCompId = (Long)attributes.get("suiteCompId");

		if (suiteCompId != null) {
			setSuiteCompId(suiteCompId);
		}
	...
	public void setSuiteCompId(long suiteCompId) {
		model.setSuiteCompId(suiteCompId);
	}
