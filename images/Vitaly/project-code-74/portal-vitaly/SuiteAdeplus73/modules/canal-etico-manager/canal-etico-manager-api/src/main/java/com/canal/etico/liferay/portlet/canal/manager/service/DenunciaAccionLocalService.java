...
/**
 * Provides the local service interface for DenunciaAccion. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see DenunciaAccionLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface DenunciaAccionLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.canal.etico.liferay.portlet.canal.manager.service.impl.DenunciaAccionLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the denuncia accion local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link DenunciaAccionLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public DenunciaAccion addDenunciaAccion(DenunciaAccion denunciaAccion);
	...
	public DenunciaAccion createDenunciaAccion(long denunciaAccionId);
	...
	public DenunciaAccion deleteDenunciaAccion(DenunciaAccion denunciaAccion);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public DenunciaAccion deleteDenunciaAccion(long denunciaAccionId)
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DenunciaAccion fetchDenunciaAccion(long denunciaAccionId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Accion> getAccionesFromDenuncia(long denunciaId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DenunciaAccion getDenunciaAccion(long denunciaAccionId)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<DenunciaAccion> getDenunciaAccionFromDenuncia(long denunciaId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<DenunciaAccion> getDenunciaAccions(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public DenunciaAccion updateDenunciaAccion(DenunciaAccion denunciaAccion);
