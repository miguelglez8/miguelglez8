...
/**
 * Provides the local service interface for Observacion. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ObservacionLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ObservacionLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.canal.etico.liferay.portlet.canal.manager.service.impl.ObservacionLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the observacion local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ObservacionLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Observacion createObservacion(long observacionId);
	...
	public Observacion deleteObservacion(long observacionId)
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Observacion deleteObservacion(Observacion observacion);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Observacion fetchObservacion(long observacionId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Observacion getObservacion(long observacionId)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Observacion> getObservacionesFromDenuncia(long denunciaId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Observacion> getObservacions(int start, int end);
