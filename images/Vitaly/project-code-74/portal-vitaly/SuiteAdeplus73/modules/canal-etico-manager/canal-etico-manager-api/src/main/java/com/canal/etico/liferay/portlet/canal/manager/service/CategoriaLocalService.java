...
public interface CategoriaLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.canal.etico.liferay.portlet.canal.manager.service.impl.CategoriaLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the categoria local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CategoriaLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Categoria> getAllCategoriasActiveFromCompany(long compId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Categoria> getAllCategoriasActiveFromCompanyByTipo(
		long compId, String tipo);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Categoria> getAllCategoriasFromCompany(long compId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Categoria> getAllConsultasActiveFromCompany(long compId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Categoria> getAllDenunciasActiveFromCompany(long compId);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Categoria> getCategoriesFromCompany(long compId);
