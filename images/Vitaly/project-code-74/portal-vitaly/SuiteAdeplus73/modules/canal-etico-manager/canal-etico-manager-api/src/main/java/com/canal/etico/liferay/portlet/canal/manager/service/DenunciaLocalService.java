...
/**
 * Provides the local service interface for Denuncia. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see DenunciaLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface DenunciaLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.canal.etico.liferay.portlet.canal.manager.service.impl.DenunciaLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the denuncia local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link DenunciaLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Denuncia createDenuncia(long denunciaId);
	...
	public Denuncia deleteDenuncia(Denuncia denuncia);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Denuncia deleteDenuncia(long denunciaId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Denuncia fetchDenuncia(long denunciaId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Denuncia getDenuncia(long denunciaId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Denuncia> getDenuncias(int start, int end);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Denuncia> getDenunciasFinishedInDate(Date finishedDate);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Denuncia> getDenunciasFromCompany(long compId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Denuncia> getDenunciasNotFinishedCreatedBeforeDate(
		Date createdDate);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Denuncia> getDenunciasNotFinishedCreatedInDate(
		Date createdDate);
