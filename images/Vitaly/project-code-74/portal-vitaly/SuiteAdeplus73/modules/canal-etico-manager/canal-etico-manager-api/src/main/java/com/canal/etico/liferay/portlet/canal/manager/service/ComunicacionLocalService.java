...
/**
 * Provides the local service interface for Comunicacion. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ComunicacionLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ComunicacionLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.canal.etico.liferay.portlet.canal.manager.service.impl.ComunicacionLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the comunicacion local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ComunicacionLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Comunicacion createComunicacion(long comunicacionId);
	...
	public Comunicacion deleteComunicacion(Comunicacion comunicacion);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Comunicacion deleteComunicacion(long comunicacionId)
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Comunicacion fetchComunicacion(long comunicacionId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Comunicacion getComunicacion(long comunicacionId)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Comunicacion> getComunicacionesFromDenuncia(long denunciaId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Comunicacion> getComunicacions(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Comunicacion updateComunicacion(Comunicacion comunicacion);
