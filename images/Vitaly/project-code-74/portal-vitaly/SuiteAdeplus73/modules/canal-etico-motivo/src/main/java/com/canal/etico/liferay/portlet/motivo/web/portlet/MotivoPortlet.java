package com.canal.etico.liferay.portlet.motivo.web.portlet;
...
@Component(
	...
	property = {
		...
		"javax.portlet.display-name=Motivo",
...
public class MotivoPortlet extends MVCPortlet {
	...
	public void doView(RenderRequest renderRequest, RenderResponse renderResponse) throws IOException, PortletException {
		...
		List<Motivo> list = MotivoLocalServiceUtil.getAllMotivosFromCompany(companyIdFromUser);

		renderRequest.setAttribute(MotivoPortletKeys.MOTIVOS_LIST, list);
		renderRequest.setAttribute(MotivoPortletKeys.COMPANY_ID, companyIdFromUser);
