...
@Component(
        ...
        property = {
                ...
                "mvc.command.name=/user/saveMulti"
        },
...
public class SaveUserMultiMVCActionCommand implements MVCActionCommand {
   ...
   public boolean processAction(ActionRequest actionRequest, ActionResponse actionResponse)  {
      ...
      clientId = ParamUtil.getLong(actionRequest, AdeplusUsersPortletKeys.USER_CLIENT_ID_EDIT, 0);
      ...
      _log.info("guardamos la lista");
      boolean changeAppList = AdeplusPermissionUserUtil.saveUserPermissionApplicationsMulti(user, companyEditId, clientId, jsonArray);
      //Save roles of user
   ...
   private User  _createNewUserProcess(ThemeDisplay themeDisplay, ActionRequest actionRequest, ActionResponse actionResponse){
      ...
      //Save permission of all applications.
      boolean appChanged = AdeplusPermissionUserUtil.saveUserPermissionApplicationsMulti(user, companyEditId, clientId, jsonArray);
