package com.adeplus.liferay.portlet.commons.web.logo;
...
public class AdeplusLogoUtil {

    private static Log _log = LogFactoryUtil.getLog(AdeplusLogoUtil.class);
    ...
    public static DLFileEntry saveLogo(long groupId, long userId, String description, String parentFolderName, String folderName, String fileName, File logo, ServiceContext serviceContext){
        ...
        if(Validator.isNull(logo) || fileName.isEmpty()){
            return null;
        }
    ...
    private static void setFilePermissionGuest(long companyId, long primKey){
        ...
        try {
            ...
            _log.error("Error setting file permission.");
        }
    ...
    public static void deleteFile(long fileEntryId){
        if(fileEntryId > 0) {
            try {
                ...
                if (Validator.isNotNull(dlFileEntryDelete)) {
