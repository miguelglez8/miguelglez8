...
public class AdeplusKeycloakBackgroundUtil {

    private static Log _log = LogFactoryUtil.getLog(AdeplusKeycloakBackgroundUtil.class);
    ...
    public static boolean createCompanyKeycloak(long compId,
        ...
        try {
            ...
            AdeplusKeycloakBackgroundUtil.setIdCRM(realm, String.valueOf(compId), idCRM, idContrato);
    ...
    public static void setIdCRM(RealmBackground realm, String companyId, String idCRM, String idContrato) {
    ...
    public static boolean operationUser(boolean isCreateUser,
                                     long companyId,
                                     long userId,
                                     String email,
                                     String name,
        ...
        try {
            ...
            try {
                ...
                if (!isCreateUser) {
                    ...
                    user = AdeplusKeycloakBackgroundUtil.getUnchecked(user, attr, arrAppsUser, companyId);
                    realm.updateUser(user);
                    realm.setUserEnabled(user, true);
                }
    ...
    public static boolean createUserKeycloak(long companyId,
										  ...
										  List<AppPermission> appPermissionList,
                                          RealmBackground realm) {
        return AdeplusKeycloakBackgroundUtil.operationUser(true,
                companyId, userLiferay.getUserId(), userLiferay.getEmailAddress(), userLiferay.getFirstName(), userLiferay.getLastName(),
                nif, phone, pass, endDate, isAdmin,appPermissionList,  realm);
    ...
    public static void updateUserKeycloak(long userId, long companyId, String name, String lastName, String nif,
        ...
        AdeplusKeycloakBackgroundUtil.operationUser(false,
                companyId, userId, email, name, lastName,
                nif, phone, null, String.valueOf((endDate != null) ? endDate.getTime() : ""), isAdmin, null, realm );
    }
