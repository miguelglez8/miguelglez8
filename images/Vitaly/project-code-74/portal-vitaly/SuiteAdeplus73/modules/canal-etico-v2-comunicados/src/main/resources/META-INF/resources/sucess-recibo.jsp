...
long idCom = Long.valueOf(PortalUtil.getOriginalServletRequest(request).getParameter("idCom"));
long compId = Long.valueOf(PortalUtil.getOriginalServletRequest(request).getParameter("compId"));
...
boolean isCaducadoRecibo = false;


if(Validator.isNotNull(comunicado) && compId != 0){

    long createMoreSevendays = comunicado.getCreateDate().getTime();
    createMoreSevendays += 7 * 24 * 60 * 60 * 1000;

    if(hoy.getTime().getTime() > createMoreSevendays ){ //7 días
        isCaducadoRecibo = true;
    }
...
<c:if test="<%= Validator.isNotNull(comunicado) && isCaducadoRecibo == false %>">
<div class="paso_finalizado">
    ...
    <div class="info-finalizado">
        <h2 class="pasoSubtitle"><liferay-ui:message key="canal.comunicado.correctoRecibi"/></h2>
...
<c:if test="<%= Validator.isNull(comunicado)  %>">
 ...
 <div class="paso_finalizado">
        ...
        <div class="info-finalizado">
            <h2 class="pasoSubtitle"><liferay-ui:message key="canal.comunicado.incorrecto"/></h2>
            <div class="iconoError">
               <!-- Icono de error -->
            </div>
        </div>
...
<c:if test="<%= Validator.isNotNull(comunicado) && isCaducadoRecibo == true %>">
    ...
    <div class="paso_finalizado">
            ...
            <div class="info-finalizado">
                <h2 class="pasoSubtitle"><liferay-ui:message key="canal.comunicado.incorrectoRecibiCaducado"/></h2>
                <div class="iconoError">
                   <!-- Icono de error -->
                </div>
            </div>
