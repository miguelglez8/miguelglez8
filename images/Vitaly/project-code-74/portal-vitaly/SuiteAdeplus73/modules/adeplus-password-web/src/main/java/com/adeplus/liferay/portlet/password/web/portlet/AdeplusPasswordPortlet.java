package com.adeplus.liferay.portlet.password.web.portlet;

import com.adeplus.liferay.portlet.password.web.constants.AdeplusPasswordPortletKeys;
...
@Component(
	...
	property = {
		...
		"javax.portlet.display-name=AdeplusPassword",
		"javax.portlet.init-param.template-path=/",
		"javax.portlet.init-param.view-template=/view.jsp",
		"javax.portlet.name=" + AdeplusPasswordPortletKeys.ADEPLUSPASSWORD,
		"javax.portlet.resource-bundle=content.Language",
		"javax.portlet.security-role-ref=power-user,user"
	},
	service = Portlet.class
)
public class AdeplusPasswordPortlet extends MVCPortlet {

	private Log _log = LogFactoryUtil.getLog(AdeplusPasswordPortletKeys.class.getName());
	...
	public void updatePassword(ActionRequest actionRequest, ActionResponse actionResponse) throws IOException {
		...
		_log.debug(":::::::::::::calling updatePassword::::::::::::::::");
