...
<c:forEach items="<%=scheduledJobs%>" var="schedule">
	...
	%>
	<c:if test="<%=schedule.getGroupName().startsWith("com.adeplus.liferay.portlet.scheduler.web.scheduler")%>">
		<div class="row">
			<div class="col-sm-4">
			...
			<div class="col-sm-1">
				<c:if test="<%=schedule.getGroupName().startsWith("com.adeplus.liferay.portlet.scheduler.web.")%>">
