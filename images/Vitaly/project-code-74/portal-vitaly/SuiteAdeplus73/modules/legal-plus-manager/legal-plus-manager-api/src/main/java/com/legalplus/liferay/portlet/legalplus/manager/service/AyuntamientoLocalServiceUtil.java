...
/**
 * Provides the local service utility for Ayuntamiento. This utility wraps
 * <code>com.legalplus.liferay.portlet.legalplus.manager.service.impl.AyuntamientoLocalServiceImpl</code> and
 ...
 * @generated
 */
public class AyuntamientoLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.legalplus.liferay.portlet.legalplus.manager.service.impl.AyuntamientoLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static
		...
		return getService().addAyuntamiento(ayuntamiento);
	}
	...
	public static
		...
		return getService().createAyuntamiento(ayuntamientoPK);
	}
	...
	public static
		...
		return getService().deleteAyuntamiento(ayuntamiento);
	}
	...
	public static
		...
		return getService().deleteAyuntamiento(ayuntamientoPK);
	}
	...
	public static
		...
		return getService().fetchAyuntamiento(ayuntamientoPK);
	}
	...
	public static
		...
		return getService().findByAyuntamiento(ayuntamientoId);
	}
	...
	public static java.util.List
		...
		return getService().findByCcaaNombre(ccaaId, nombre);
	}
	...
	public static
		...
		return getService().getAyuntamiento(ayuntamientoPK);
	}
	...
	public static java.util.List
		...
		return getService().getAyuntamientos(start, end);
	}
	...
	public static java.util.List
		...
		return getService().getAyuntamientosByCcaa(ccaaId);
	}
	 ...
	 */
	public static int getAyuntamientosCount() {
		return getService().getAyuntamientosCount();
	}
	...
	public static
		...
		return getService().updateAyuntamiento(ayuntamiento);
	}

	public static AyuntamientoLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker
		<AyuntamientoLocalService, AyuntamientoLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(AyuntamientoLocalService.class);

		ServiceTracker<AyuntamientoLocalService, AyuntamientoLocalService>
			serviceTracker =
				new ServiceTracker
					<AyuntamientoLocalService, AyuntamientoLocalService>(
						bundle.getBundleContext(),
						AyuntamientoLocalService.class, null);
