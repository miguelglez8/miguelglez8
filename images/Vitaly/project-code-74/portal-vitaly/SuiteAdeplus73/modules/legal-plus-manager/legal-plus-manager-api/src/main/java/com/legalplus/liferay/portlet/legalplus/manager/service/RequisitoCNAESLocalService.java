...
import com.legalplus.liferay.portlet.legalplus.manager.model.RequisitoCNAES;
...
/**
 * Provides the local service interface for RequisitoCNAES. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see RequisitoCNAESLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface RequisitoCNAESLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.legalplus.liferay.portlet.legalplus.manager.service.impl.RequisitoCNAESLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the requisito cnaes local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link RequisitoCNAESLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public RequisitoCNAES addRequisitoCNAES(RequisitoCNAES requisitoCNAES);
	...
	public RequisitoCNAES createRequisitoCNAES(
	...
	public RequisitoCNAES deleteRequisitoCNAES(RequisitoCNAES requisitoCNAES);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public RequisitoCNAES deleteRequisitoCNAES(
			RequisitoCNAESPK requisitoCNAESPK)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public RequisitoCNAES fetchRequisitoCNAES(
		RequisitoCNAESPK requisitoCNAESPK);

	public List<RequisitoCNAES> findByRequisito(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public RequisitoCNAES getRequisitoCNAES(RequisitoCNAESPK requisitoCNAESPK)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<RequisitoCNAES> getRequisitoCNAESs(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public RequisitoCNAES updateRequisitoCNAES(RequisitoCNAES requisitoCNAES);
