...
/**
 * Provides the local service interface for HiddenLegis. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see HiddenLegisLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface HiddenLegisLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.legalplus.liferay.portlet.legalplus.manager.service.impl.HiddenLegisLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the hidden legis local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link HiddenLegisLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public HiddenLegis addHiddenLegis(HiddenLegis hiddenLegis);
	...
	public HiddenLegis createHiddenLegis(HiddenLegisPK hiddenLegisPK);
	...
	public HiddenLegis deleteHiddenLegis(HiddenLegis hiddenLegis);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public HiddenLegis deleteHiddenLegis(HiddenLegisPK hiddenLegisPK)
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public HiddenLegis fetchHiddenLegis(HiddenLegisPK hiddenLegisPK);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<String> fetchLegisByEmpresaId(long empresaId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public HiddenLegis getHiddenLegis(HiddenLegisPK hiddenLegisPK)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<HiddenLegis> getHiddenLegises(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public HiddenLegis updateHiddenLegis(HiddenLegis hiddenLegis);
