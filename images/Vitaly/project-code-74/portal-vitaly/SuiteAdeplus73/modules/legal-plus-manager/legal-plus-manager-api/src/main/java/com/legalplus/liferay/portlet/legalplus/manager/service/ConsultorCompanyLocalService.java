...
/**
 * Provides the local service interface for ConsultorCompany. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ConsultorCompanyLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ConsultorCompanyLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.legalplus.liferay.portlet.legalplus.manager.service.impl.ConsultorCompanyLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the consultor company local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ConsultorCompanyLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public ConsultorCompany addConsultorCompany(
	...
	public ConsultorCompany createConsultorCompany(
		ConsultorCompanyPK consultorCompanyPK);
	...
	public ConsultorCompany deleteConsultorCompany(
		ConsultorCompany consultorCompany);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ConsultorCompany> fetchByCompId(Long compId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ConsultorCompany> fetchByCompIdAndAppId(
		Long compId, Long appId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ConsultorCompany> fetchByUserId(Long userId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ConsultorCompany fetchConsultorCompany(
		ConsultorCompanyPK consultorCompanyPK);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ConsultorCompany> getConsultorCompanies(int start, int end);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ConsultorCompany getConsultorCompany(
			ConsultorCompanyPK consultorCompanyPK)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public ConsultorCompany updateConsultorCompany(
		ConsultorCompany consultorCompany);
