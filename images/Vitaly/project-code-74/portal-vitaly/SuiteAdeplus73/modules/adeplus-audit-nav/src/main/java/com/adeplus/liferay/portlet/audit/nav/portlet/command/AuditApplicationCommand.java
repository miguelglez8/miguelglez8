...
@Component(
        ...
        property = {
                ...
                "mvc.command.name=auditApplication"
        },
        service = MVCResourceCommand.class
)

public class AuditApplicationCommand extends BaseMVCResourceCommand {
        private static Log _log = LogFactoryUtil.getLog(AuditApplicationCommand.class);
        ...
        protected void doServeResource(ResourceRequest resourceRequest, ResourceResponse resourceResponse) throws Exception {
                ...
                String aplicacion=httpReq.getParameter("aplicacion");
                long userId=Long.parseLong(httpReq.getParameter("userId"));
                String auditoria=StringPool.BLANK;
                ...
                auditoria = "IP: " + usuarioReal.getLoginIP() + "(Simulando); Fecha y hora: " + dateTime + "; Accion Realizada: Acceso a la aplicacion " + aplicacion + "; Usuario: " +
