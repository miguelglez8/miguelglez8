 ...
 * <code>com.plan.igualdad.liferay.portlet.manager.service.impl.RespuestaLocalServiceImpl</code> and
...
public class RespuestaLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.plan.igualdad.liferay.portlet.manager.service.impl.RespuestaLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static com.plan.igualdad.liferay.portlet.manager.model.Respuesta
		addRespuesta(
	...
	public static com.plan.igualdad.liferay.portlet.manager.model.Respuesta
		...
		return getService().createRespuesta(respuestaPK);
	}
	...
	public static com.plan.igualdad.liferay.portlet.manager.model.Respuesta
		...
		return getService().deleteRespuesta(respuestaPK);
	}
	...
	public static com.plan.igualdad.liferay.portlet.manager.model.Respuesta
		...
		return getService().fetchRespuesta(respuestaPK);
	}

	public static com.plan.igualdad.liferay.portlet.manager.model.Respuesta
		fetchRespuestaBySeccion(long compId, long versionId, long seccionId) {

		return getService().fetchRespuestaBySeccion(
	...
	public static java.util.List
		...
		return getService().fetchRespuestas(compId, versionId);
	}
	...
	public static com.plan.igualdad.liferay.portlet.manager.model.Respuesta
		...
		return getService().getRespuesta(respuestaPK);
	}
	...
	private static ServiceTracker<RespuestaLocalService, RespuestaLocalService>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(RespuestaLocalService.class);

		ServiceTracker<RespuestaLocalService, RespuestaLocalService>
			serviceTracker =
				new ServiceTracker
					<RespuestaLocalService, RespuestaLocalService>(
						bundle.getBundleContext(), RespuestaLocalService.class,
						null);
