...
/**
 * Provides the local service interface for Cuestionario. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CuestionarioLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CuestionarioLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.plan.igualdad.liferay.portlet.manager.service.impl.CuestionarioLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the cuestionario local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CuestionarioLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Cuestionario createCuestionario(long cuestionarioId);
	...
	public Cuestionario deleteCuestionario(Cuestionario cuestionario);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Cuestionario deleteCuestionario(long cuestionarioId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Cuestionario fetchCuestionario(long cuestionarioId);

	public List<Cuestionario> findByComp(long compId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Cuestionario getCuestionario(long cuestionarioId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Cuestionario> getCuestionarios(int start, int end);
