...
public interface EvaluacionLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.plan.igualdad.liferay.portlet.manager.service.impl.EvaluacionLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the evaluacion local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link EvaluacionLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public List<Evaluacion> findByComp(long compId);

	public List<Evaluacion> findByCompVersion(long compId, long versionId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Evaluacion getEvaluacion(long evaluacionId) throws PortalException;
