...
import com.plan.igualdad.liferay.portlet.manager.model.EstadoEmpresa;
...
/**
 * Provides the local service interface for EstadoEmpresa. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see EstadoEmpresaLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface EstadoEmpresaLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.plan.igualdad.liferay.portlet.manager.service.impl.EstadoEmpresaLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the estado empresa local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link EstadoEmpresaLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public EstadoEmpresa addEstadoEmpresa(EstadoEmpresa estadoEmpresa);
	...
	public EstadoEmpresa createEstadoEmpresa(long compId);
	...
	public EstadoEmpresa deleteEstadoEmpresa(EstadoEmpresa estadoEmpresa);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public EstadoEmpresa deleteEstadoEmpresa(long compId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public EstadoEmpresa fetchEstadoEmpresa(long compId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public EstadoEmpresa getEstadoEmpresa(long compId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<EstadoEmpresa> getEstadoEmpresas(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public EstadoEmpresa updateEstadoEmpresa(EstadoEmpresa estadoEmpresa);
