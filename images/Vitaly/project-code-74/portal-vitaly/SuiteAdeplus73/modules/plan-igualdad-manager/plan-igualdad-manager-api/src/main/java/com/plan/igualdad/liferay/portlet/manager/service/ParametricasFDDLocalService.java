...
/**
 * Provides the local service interface for ParametricasFDD. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ParametricasFDDLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ParametricasFDDLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.plan.igualdad.liferay.portlet.manager.service.impl.ParametricasFDDLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the parametricas fdd local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ParametricasFDDLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public ParametricasFDD addParametricasFDD(ParametricasFDD parametricasFDD);
	...
	public ParametricasFDD createParametricasFDD(
	...
	public ParametricasFDD deleteParametricasFDD(
		ParametricasFDD parametricasFDD);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ParametricasFDD fetchParametricasFDD(
		ParametricasFDDPK parametricasFDDPK);

	public ParametricasFDD findParametrica(
		long compId, long versionId, String idParametrica);

	public List<ParametricasFDD> findParametricasByCompIdAndVersion(
		long compId, long versionId);

	public List<ParametricasFDD> findParametricasByMateria(
		long compId, long versionId, String tipo, Integer materia);

	public List<ParametricasFDD> findParametricasByTipo(
		long compId, long versionId, String tipo);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ParametricasFDD getParametricasFDD(
			ParametricasFDDPK parametricasFDDPK)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ParametricasFDD> getParametricasFDDs(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public ParametricasFDD updateParametricasFDD(
		ParametricasFDD parametricasFDD);
