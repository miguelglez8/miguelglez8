 ...
 * <code>com.plan.igualdad.liferay.portlet.manager.service.impl.EvaluacionLocalServiceImpl</code> and
...
public class EvaluacionLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.plan.igualdad.liferay.portlet.manager.service.impl.EvaluacionLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static com.plan.igualdad.liferay.portlet.manager.model.Evaluacion
		addEvaluacion(
	...
	private static ServiceTracker
		<EvaluacionLocalService, EvaluacionLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(EvaluacionLocalService.class);

		ServiceTracker<EvaluacionLocalService, EvaluacionLocalService>
			serviceTracker =
				new ServiceTracker
					<EvaluacionLocalService, EvaluacionLocalService>(
						bundle.getBundleContext(), EvaluacionLocalService.class,
						null);
