...
/**
 * Provides the local service interface for Estadistica. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see EstadisticaLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface EstadisticaLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.plan.igualdad.liferay.portlet.manager.service.impl.EstadisticaLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the estadistica local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link EstadisticaLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Estadistica createEstadistica(EstadisticaPK estadisticaPK);
	...
	public Estadistica deleteEstadistica(Estadistica estadistica);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Estadistica deleteEstadistica(EstadisticaPK estadisticaPK)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Estadistica fetchEstadistica(EstadisticaPK estadisticaPK);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Estadistica> fetchEstadistica(long compId, long versionId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Estadistica fetchEstadisticasBySection(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Estadistica getEstadistica(EstadisticaPK estadisticaPK)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Estadistica> getEstadisticas(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Estadistica updateEstadistica(Estadistica estadistica);
