...
/**
 * Provides the local service interface for Informes. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see InformesLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface InformesLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.plan.igualdad.liferay.portlet.manager.service.impl.InformesLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the informes local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link InformesLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Informes addInformes(Informes informes);
	...
	public Informes createInformes(long informeId);
	...
	public Informes deleteInformes(Informes informes);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Informes deleteInformes(long informeId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Informes fetchInformes(long informeId);

	public List<Informes> findInformesByComp(long compId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Informes getInformes(long informeId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Informes> getInformeses(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Informes updateInformes(Informes informes);
