...
public interface AreaLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.plan.igualdad.liferay.portlet.manager.service.impl.AreaLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the area local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AreaLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Area createArea(AreaPK areaPK);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Area deleteArea(AreaPK areaPK) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Area fetchArea(AreaPK areaPK);

	public List<Area> findByArea(long compId, long versionId);

	public List<Area> findByAreaActiva(long compId, long versionId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Area getArea(AreaPK areaPK) throws PortalException;
