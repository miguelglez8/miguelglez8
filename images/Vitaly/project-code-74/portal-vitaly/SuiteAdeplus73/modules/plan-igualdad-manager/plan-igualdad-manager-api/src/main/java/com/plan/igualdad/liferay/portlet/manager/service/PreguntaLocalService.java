...
public interface PreguntaLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.plan.igualdad.liferay.portlet.manager.service.impl.PreguntaLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the pregunta local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link PreguntaLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Pregunta createPregunta(PreguntaPK preguntaPK);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Pregunta deletePregunta(PreguntaPK preguntaPK)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Pregunta fetchPregunta(PreguntaPK preguntaPK);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Map<Long, List<Pregunta>> fetchSecciones();

	public List<Pregunta> findBySeccion(Long seccionId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Pregunta getPregunta(PreguntaPK preguntaPK) throws PortalException;
