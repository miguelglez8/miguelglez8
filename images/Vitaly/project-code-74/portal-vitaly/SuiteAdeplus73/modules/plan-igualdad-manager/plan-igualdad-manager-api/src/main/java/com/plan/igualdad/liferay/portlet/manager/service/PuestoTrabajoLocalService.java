...
/**
 * Provides the local service interface for PuestoTrabajo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see PuestoTrabajoLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface PuestoTrabajoLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.plan.igualdad.liferay.portlet.manager.service.impl.PuestoTrabajoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the puesto trabajo local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link PuestoTrabajoLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public PuestoTrabajo createPuestoTrabajo(PuestoTrabajoPK puestoTrabajoPK);
	...
	public PuestoTrabajo deletePuestoTrabajo(PuestoTrabajo puestoTrabajo);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public PuestoTrabajo deletePuestoTrabajo(PuestoTrabajoPK puestoTrabajoPK)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public PuestoTrabajo fetchPuestoTrabajo(PuestoTrabajoPK puestoTrabajoPK);

	public List<PuestoTrabajo> findByPuestoArea(
		long compId, long versionId, long areaId);

	public List<PuestoTrabajo> findByPuestoResponsabilidad(
		long compId, long versionId);

	public List<PuestoTrabajo> findPuestoTrabajo(long compId, long versionId);

	public List<PuestoTrabajo> findPuestoTrabajoActivo(
		long compId, long versionId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public PuestoTrabajo getPuestoTrabajo(PuestoTrabajoPK puestoTrabajoPK)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<PuestoTrabajo> getPuestoTrabajos(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public PuestoTrabajo updatePuestoTrabajo(PuestoTrabajo puestoTrabajo);
