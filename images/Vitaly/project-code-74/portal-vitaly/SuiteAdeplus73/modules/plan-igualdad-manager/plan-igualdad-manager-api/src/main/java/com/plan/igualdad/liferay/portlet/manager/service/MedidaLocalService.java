...
/**
 * Provides the local service interface for Medida. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see MedidaLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface MedidaLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.plan.igualdad.liferay.portlet.manager.service.impl.MedidaLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the medida local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link MedidaLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Medida createMedida(long medidaId);
	...
	public Medida deleteMedida(long medidaId) throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Medida deleteMedida(Medida medida);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Medida fetchMedida(long medidaId);

	public List<Medida> findByComp(long compId);

	public List<Medida> findByCompVersion(long compId, long versionId);

	public Medida findMedidaPredefinida(long compId, String medidaPredefinida);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Medida getMedida(long medidaId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Medida> getMedidas(int start, int end);
