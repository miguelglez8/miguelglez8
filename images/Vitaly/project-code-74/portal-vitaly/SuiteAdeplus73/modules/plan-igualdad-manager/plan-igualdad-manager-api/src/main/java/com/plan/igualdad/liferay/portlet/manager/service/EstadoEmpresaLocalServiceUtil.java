...
/**
 * Provides the local service utility for EstadoEmpresa. This utility wraps
 * <code>com.plan.igualdad.liferay.portlet.manager.service.impl.EstadoEmpresaLocalServiceImpl</code> and
 ...
 * @generated
 */
public class EstadoEmpresaLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.plan.igualdad.liferay.portlet.manager.service.impl.EstadoEmpresaLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static com.plan.igualdad.liferay.portlet.manager.model.EstadoEmpresa
		addEstadoEmpresa(
			com.plan.igualdad.liferay.portlet.manager.model.EstadoEmpresa
				estadoEmpresa) {

		return getService().addEstadoEmpresa(estadoEmpresa);
	}
	...
	public static com.plan.igualdad.liferay.portlet.manager.model.EstadoEmpresa
		...
		return getService().createEstadoEmpresa(compId);
	}
	...
	public static com.plan.igualdad.liferay.portlet.manager.model.EstadoEmpresa
		...
		return getService().deleteEstadoEmpresa(estadoEmpresa);
	}
	...
	public static com.plan.igualdad.liferay.portlet.manager.model.EstadoEmpresa
		...
		return getService().deleteEstadoEmpresa(compId);
	}
	...
	public static com.plan.igualdad.liferay.portlet.manager.model.EstadoEmpresa
		...
		return getService().fetchEstadoEmpresa(compId);
	}
	...
	public static com.plan.igualdad.liferay.portlet.manager.model.EstadoEmpresa
		...
		return getService().getEstadoEmpresa(compId);
	}
	...
	public static java.util.List
		...
		return getService().getEstadoEmpresas(start, end);
	}
	 ...
	 */
	public static int getEstadoEmpresasCount() {
		return getService().getEstadoEmpresasCount();
	}
	...
	public static com.plan.igualdad.liferay.portlet.manager.model.EstadoEmpresa
		...
		return getService().updateEstadoEmpresa(estadoEmpresa);
	}

	public static EstadoEmpresaLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker
		<EstadoEmpresaLocalService, EstadoEmpresaLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(
			EstadoEmpresaLocalService.class);

		ServiceTracker<EstadoEmpresaLocalService, EstadoEmpresaLocalService>
			serviceTracker =
				new ServiceTracker
					<EstadoEmpresaLocalService, EstadoEmpresaLocalService>(
						bundle.getBundleContext(),
						EstadoEmpresaLocalService.class, null);
