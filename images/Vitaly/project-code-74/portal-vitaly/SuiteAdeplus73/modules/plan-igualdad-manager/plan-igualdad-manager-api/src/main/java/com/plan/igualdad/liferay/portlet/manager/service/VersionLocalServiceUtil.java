 ...
 * <code>com.plan.igualdad.liferay.portlet.manager.service.impl.VersionLocalServiceImpl</code> and
...
public class VersionLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.plan.igualdad.liferay.portlet.manager.service.impl.VersionLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static com.plan.igualdad.liferay.portlet.manager.model.Version
		addVersion(
	...
	public static com.plan.igualdad.liferay.portlet.manager.model.Version
		...
		return getService().createVersion(versionPK);
	}
	...
	public static com.plan.igualdad.liferay.portlet.manager.model.Version
		...
		return getService().deleteVersion(versionPK);
	}
	...
	public static com.plan.igualdad.liferay.portlet.manager.model.Version
		...
		return getService().fetchVersion(versionPK);
	}
	...
	public static com.plan.igualdad.liferay.portlet.manager.model.Version
		...
		return getService().findVersionActiva(compId);
	}
	...
	public static com.plan.igualdad.liferay.portlet.manager.model.Version
		...
		return getService().getVersion(versionPK);
	}
	...
	private static ServiceTracker<VersionLocalService, VersionLocalService>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(VersionLocalService.class);

		ServiceTracker<VersionLocalService, VersionLocalService>
			serviceTracker =
				new ServiceTracker<VersionLocalService, VersionLocalService>(
					bundle.getBundleContext(), VersionLocalService.class, null);
