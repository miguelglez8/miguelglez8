...
public interface VersionLocalService
	...
	public Version createVersion(VersionPK versionPK);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Version deleteVersion(VersionPK versionPK) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Version fetchVersion(VersionPK versionPK);

	public List<Version> findByComp(long compId);

	public Version findVersionActiva(long compId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Version getVersion(VersionPK versionPK) throws PortalException;
