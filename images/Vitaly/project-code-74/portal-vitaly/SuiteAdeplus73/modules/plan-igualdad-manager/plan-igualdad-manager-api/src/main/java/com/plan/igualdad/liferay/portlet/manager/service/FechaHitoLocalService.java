...
/**
 * Provides the local service interface for FechaHito. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see FechaHitoLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface FechaHitoLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.plan.igualdad.liferay.portlet.manager.service.impl.FechaHitoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the fecha hito local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link FechaHitoLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public FechaHito addFechaHito(FechaHito fechaHito);
	...
	public FechaHito createFechaHito(FechaHitoPK fechaHitoPK);
	...
	public FechaHito deleteFechaHito(FechaHito fechaHito);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public FechaHito deleteFechaHito(FechaHitoPK fechaHitoPK)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public FechaHito fetchFechaHito(FechaHitoPK fechaHitoPK);

	public List<FechaHito> findByCompVersion(long compId, long versionId);

	public List<FechaHito> findByCompVersionEjecutados(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public FechaHito getFechaHito(FechaHitoPK fechaHitoPK)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<FechaHito> getFechaHitos(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public FechaHito updateFechaHito(FechaHito fechaHito);
