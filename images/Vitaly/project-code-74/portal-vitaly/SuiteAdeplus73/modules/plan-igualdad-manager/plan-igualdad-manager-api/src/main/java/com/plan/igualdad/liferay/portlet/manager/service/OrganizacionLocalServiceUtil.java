...
/**
 * Provides the local service utility for Organizacion. This utility wraps
 * <code>com.plan.igualdad.liferay.portlet.manager.service.impl.OrganizacionLocalServiceImpl</code> and
 ...
 * @generated
 */
public class OrganizacionLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.plan.igualdad.liferay.portlet.manager.service.impl.OrganizacionLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static com.plan.igualdad.liferay.portlet.manager.model.Organizacion
		addOrganizacion(
			com.plan.igualdad.liferay.portlet.manager.model.Organizacion
				organizacion) {

		return getService().addOrganizacion(organizacion);
	}
	...
	public static com.plan.igualdad.liferay.portlet.manager.model.Organizacion
		...
		return getService().createOrganizacion(organizacionPK);
	}
	...
	public static com.plan.igualdad.liferay.portlet.manager.model.Organizacion
		...
		return getService().deleteOrganizacion(organizacion);
	}
	...
	public static com.plan.igualdad.liferay.portlet.manager.model.Organizacion
		...
		return getService().deleteOrganizacion(organizacionPK);
	}
	...
	public static com.plan.igualdad.liferay.portlet.manager.model.Organizacion
		...
		return getService().fetchOrganizacion(organizacionPK);
	}

	public static com.plan.igualdad.liferay.portlet.manager.model.Organizacion
		findByOrganizacion(long compId, long versionId) {

		return getService().findByOrganizacion(compId, versionId);
	}
	...
	public static com.plan.igualdad.liferay.portlet.manager.model.Organizacion
		...
		return getService().getOrganizacion(organizacionPK);
	}
	...
	public static java.util.List
		...
		return getService().getOrganizacions(start, end);
	}
	 ...
	 */
	public static int getOrganizacionsCount() {
		return getService().getOrganizacionsCount();
	}
	...
	public static com.plan.igualdad.liferay.portlet.manager.model.Organizacion
		...
		return getService().updateOrganizacion(organizacion);
	}

	public static OrganizacionLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker
		<OrganizacionLocalService, OrganizacionLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(OrganizacionLocalService.class);

		ServiceTracker<OrganizacionLocalService, OrganizacionLocalService>
			serviceTracker =
				new ServiceTracker
					<OrganizacionLocalService, OrganizacionLocalService>(
						bundle.getBundleContext(),
						OrganizacionLocalService.class, null);
