...
<%@ page import="com.adeplus.liferay.portlet.contact.form.web.util.AdeplusCategoryUtil" %>
<%@ page import="java.util.Arrays" %>
<%@ page import="java.util.List" %>
<%@ page import="java.util.Locale" %>
<%@ page import="java.util.Map" %>
<%@ page import="com.adeplus.liferay.portlet.contact.form.web.constants.AdeplusContactPortletKeys" %>
...
<%
    ...
    Map<Locale, String> categoriesLocalized = LocalizationUtil.getLocalizationMap(preferences, AdeplusContactPortletKeys.CATEGORIES_CONFIGURATION);
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <aui:form action="<%= configurationURL.toString() %>" method="post" >
                    ...
                    <liferay-ui:input-localized id="categories" name="categories" CssClass="col-md-12" xml="<%=AdeplusCategoryUtil.getXmlFromMap(categoriesLocalized)%>" maxLength="100" helpMessage="contact.form.config.categories.help"/>
