...
@Component(
        immediate = true,
        service = MessagingConfigurator.class
)
public class MessagingConfigurator {

    private static Log _log = LogFactoryUtil.getLog(MessagingConfigurator.class);
    ...
    protected void activate(BundleContext bundleContext) {
        ...
        DestinationConfiguration destinationConfiguration =
                new DestinationConfiguration(DestinationConfiguration.DESTINATION_TYPE_PARALLEL, AdeplusMailingPortletKeys.MESSAGE_BUS_DESTINATION_NAME);
