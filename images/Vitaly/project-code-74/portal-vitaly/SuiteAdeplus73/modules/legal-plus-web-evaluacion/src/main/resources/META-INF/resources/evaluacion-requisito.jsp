...
<%@ page import="com.legalplus.liferay.portlet.legalplus.manager.model.EvalRequisito" %>
...
EvalRequisito evaluacion = (EvalRequisito) request.getAttribute(WebEvaluacionPortletKeys.EVALUACION);
Legislacion legislacion = (Legislacion) request.getAttribute(WebEvaluacionPortletKeys.LEGISLACION);
Requisito requisito = (Requisito) request.getAttribute(WebEvaluacionPortletKeys.REQUISITO);
...
if (Validator.isNotNull(evaluacion)) {
    ...
    if (Validator.isNotNull(evaluacion.getFecha())) {
...
<div class="content">
    <div class="formulario">
        ...
        <div class="form-content prv-search prv-form mr-sm-0 mr-md-3 mb-md-3 mb-lg-0 ">
             ...
             <liferay-portlet:actionURL name="/evaluacion/requisito/save" var="evaluacionURL" />
             <aui:form  name="contract_form" action="<%=evaluacionURL.toString()%>" method="post" enctype="multipart/form-data">
                ...
                <aui:input type="hidden" name="<%= WebEvaluacionPortletKeys.REQUISITO_PARAM %>" value="<%= requisito.getRequisitoId() %>"></aui:input>
                ...
                <div class="row align-items-start mb-4">
                    ...
                    <div class="form-group col-md-12 col-12">
                        <div class="form-group input-text-wrapper">
                            <label class="control-label">
                                <liferay-ui:message key="evaluacion.view.requisito"/>
                            </label>
                            <p><%= requisito.getDescripcion() %></p>
                        </div>
                    </div>
                    ...
                    <div class="form-group col-md-6 col-12 required">
                        <fieldset class="">
                            ...
                            <div class="custom-control custom-radio mr-4">
                                <input class="form-check-input" name="<portlet:namespace/><%= WebEvaluacionPortletKeys.CUMPLIMIENTO %>" id="cumplimiento1" value="0" type="radio"
                                    <%= Validator.isNull(evaluacion) ?  "checked" : Validator.isNotNull(evaluacion) && evaluacion.getCumplimiento() == 0 ? "checked" : "" %> />
