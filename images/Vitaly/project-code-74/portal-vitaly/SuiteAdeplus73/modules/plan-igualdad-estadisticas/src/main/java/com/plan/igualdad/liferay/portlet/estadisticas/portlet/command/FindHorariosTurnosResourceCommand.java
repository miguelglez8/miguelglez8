...
@Component(
        ...
        property= {
                ...
                "mvc.command.name=findHorariosTurnos"
        },
        service = MVCResourceCommand.class
)
public class FindHorariosTurnosResourceCommand extends BaseMVCResourceCommand {
        ...
        protected void doServeResource(ResourceRequest resourceRequest, ResourceResponse resourceResponse) throws Exception {
                ...
                estadisticaPK.setSeccionId(PlanIgualdadEstadisticasPortletKeys.HORARIO_TURNOS);
                ...
                if (Validator.isNotNull(estadistica)) {
                        ...
                        String[] jornadas = {"CON", "PAR"};
                        String[] turnos = {"CTUR", "STUR"};
