...
@Component(
        ...
        property= {
                ...
                "mvc.command.name=findOcupaciones"
        },
        service = MVCResourceCommand.class
)
public class FindOcupacionesResourceCommand extends BaseMVCResourceCommand {
    ...
    protected void doServeResource(ResourceRequest resourceRequest, ResourceResponse resourceResponse) throws Exception {
        ...
        estadisticaPK.setSeccionId(PlanIgualdadEstadisticasPortletKeys.OCUPACION_SECTOR);
