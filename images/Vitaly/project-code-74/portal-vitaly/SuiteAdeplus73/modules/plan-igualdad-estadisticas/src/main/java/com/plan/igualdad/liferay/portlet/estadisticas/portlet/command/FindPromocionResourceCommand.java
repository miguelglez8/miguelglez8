...
@Component(
        ...
        property= {
                ...
                "mvc.command.name=findPromocion"
        },
        service = MVCResourceCommand.class
)
public class FindPromocionResourceCommand extends BaseMVCResourceCommand {
    ...
    protected void doServeResource(ResourceRequest resourceRequest, ResourceResponse resourceResponse) throws Exception {
        ...
        estadisticaPK.setSeccionId(PlanIgualdadEstadisticasPortletKeys.PROMOCION);
        ...
        if (Validator.isNotNull(estadistica)) {
            ...
            situacionIltJSON.put("promocion", "PRO");
