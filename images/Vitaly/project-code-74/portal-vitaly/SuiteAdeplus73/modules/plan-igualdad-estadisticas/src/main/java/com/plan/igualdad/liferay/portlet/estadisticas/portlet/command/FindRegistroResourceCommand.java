...
@Component(
        ...
        property= {
                ...
                "mvc.command.name=findRegistro"
        },
        service = MVCResourceCommand.class
)
public class FindRegistroResourceCommand extends BaseMVCResourceCommand {
        ...
        protected void doServeResource(ResourceRequest resourceRequest, ResourceResponse resourceResponse) throws Exception {
                ...
                estadisticaPK.setSeccionId(PlanIgualdadEstadisticasPortletKeys.REGISTRO);
