...
@Component(
        ...
        property= {
                ...
                "mvc.command.name=findEdad"
        },
        service = MVCResourceCommand.class
)
public class FindEdadResourceCommand extends BaseMVCResourceCommand {
    ...
    protected void doServeResource(ResourceRequest resourceRequest, ResourceResponse resourceResponse) throws Exception {
        ...
        estadisticaPK.setSeccionId(PlanIgualdadEstadisticasPortletKeys.EDAD);
        ...
        if (Validator.isNotNull(estadistica)) {
            ...
            for (String edad : edades) {
                ...
                JSONObject edadJSON = JSONFactoryUtil.createJSONObject();
                edadJSON.put("id", edad);
                edadJSON.put("hombres", 0);
                edadJSON.put("mujeres", 0);
