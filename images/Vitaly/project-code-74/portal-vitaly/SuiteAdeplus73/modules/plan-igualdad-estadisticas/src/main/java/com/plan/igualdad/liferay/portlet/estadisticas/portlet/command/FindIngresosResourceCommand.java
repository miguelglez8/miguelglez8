...
@Component(
        ...
        property= {
                ...
                "mvc.command.name=findIngresos"
        },
        service = MVCResourceCommand.class
)
public class FindIngresosResourceCommand extends BaseMVCResourceCommand {
        ...
        protected void doServeResource(ResourceRequest resourceRequest, ResourceResponse resourceResponse) throws Exception {
                ...
                estadisticaPK.setSeccionId(PlanIgualdadEstadisticasPortletKeys.INGRESOS);
