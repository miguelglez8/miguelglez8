package com.legalplus.liferay.portlet.admin.categorias.web.portlet;
...
@Component(
	...
	property = {
		...
		"javax.portlet.display-name=AdminCategorias",
...
public class AdminCategoriasPortlet extends MVCPortlet {
}