...
@Component(
        ...
        property= {
                ...
                "mvc.command.name=buscarEvaluacionesRequisito"
        },
        service = MVCResourceCommand.class
)
public class FindEvaluacionesRequisitoResourceCommand extends BaseMVCResourceCommand {
    ...
    protected void doServeResource(ResourceRequest resourceRequest, ResourceResponse resourceResponse) throws Exception {
        ...
        String resultados = EvalRequisitoLocalServiceUtil.getCalendarioEvalRequisitos(Long.valueOf(compId));
