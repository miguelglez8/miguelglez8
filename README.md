...
Technologies & tools: Java, Liferay 7.4, JSP, React, HTML/CSS, JavaScript, REST APIs, Docker, Git, Service Builder, REST Builder, microservices, relational and non-relational databases (MySQL, MongoDB), cloud platforms (AWS, Firebase), Spring Boot.
